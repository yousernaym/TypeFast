...
namespace TyperUWPTest
{
    ...
    public class TextsTest
    {
        ...
        public void getRecords()
        {
			...
			//Get 3 records
			var records = texts.getRecords(Texts.RecordSortMethod.FastestSessions, Record.PrimarySortType.Wpm, 3);
			...
			records = texts.getRecords(Texts.RecordSortMethod.FastestTexts, Record.PrimarySortType.Wpm,  2);
			...
			records = texts.getRecords(Texts.RecordSortMethod.SlowestTexts, Record.PrimarySortType.Wpm, 4);
			...
			records = texts.getRecords(Texts.RecordSortMethod.FastestSessions, Record.PrimarySortType.Wpm, 0);
